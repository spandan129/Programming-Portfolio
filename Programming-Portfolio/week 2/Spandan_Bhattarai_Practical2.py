...
#The third letter of the surname is: a

#15
surname = "Bhattaraii"
initial = surname[9]
print("The tenth letter of the surname is:", initial)
#The tenth letter of the surname is: i

#16
surname = "bhattarai"
initial = surname[-2]
print("The second letter of the surname from last is:", initial)
#The he second letter of the surname from last is: a
...
print("List :", names)
#List : ['Terry', 'John', 'Michael', 'Eric', 'Terry', 'Graham', 'Spandan', 'Bhattarai']
